...
4. **Chọn task (Task Selection) - HUMAN**
   ...
   - **Bắt buộc:** Sau khi Agent hoàn thành bất kỳ Task nào được giao, Agent TRÁCH NHIỆM phải mở lại file `task_selection.md` và đánh dấu `[v]` hoặc `[hoàn thành]` cho Task đó, để Người dùng dễ dàng theo dõi tiến độ và chọn Task tiếp theo.
